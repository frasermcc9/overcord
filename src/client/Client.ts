...
import { SlashCommandLoader } from "../commands/slash/SlashCommandLoader";
...
export default class Client extends BaseClient {
  ...
  private readonly _slashCommandLoader;
  ...
  constructor(options: Options) {
    ...
    this.on("messageCreate", (m) => this.dispatcher.handleRawMessage(m));
  }
